...
public class User {
    ...
    public User(String email, String name, String cpf, String password, String birthday) {
         ...
         * 
         * if (!emailIsOk) {
         * throw new IllegalArgumentException("Por favor, verifique se o e-mail
         * fornecido está correto");
         * }
         * if (!nameIsOk) {
         * throw new IllegalArgumentException("Por favor, verifique se o Nome fornecido
         * está correto");
         * }
         * if (!cpfIsOk) {
         * throw new IllegalArgumentException("Por favor, verifique se o CPF fornecido
         * está correto");
         * }
         * if (!passwordIsOk) {
         * throw new IllegalArgumentException("Por favor, verifique se a senha fornecida
         * está correta");
         * }
         * if (!birthdayIsOk) {
         * throw new IllegalArgumentException("Por favor, verifique se a data de
         * nascimento fornecida está correta");
         * }
